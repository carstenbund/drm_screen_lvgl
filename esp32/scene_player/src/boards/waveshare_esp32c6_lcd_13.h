 ...
 *     other board here is Xtensa LX7. mementum-lcd's docs/esp32-bring-up.md's CI result
 ...
 *     interface. mementum-lcd's docs/esp32-bring-up.md's whole memory budget assumes the
