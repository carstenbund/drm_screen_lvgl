 ...
 * mementum-lcd's docs/esp32-bring-up.md puts the canvas there (480x320 ARGB8888 is ~614 KB).
 ...
 * mementum-lcd's docs/esp32-bring-up.md don't need it, and the two chips differ enough
 ...
 * these defines, not anything in panel_bridge.cpp.
 */
